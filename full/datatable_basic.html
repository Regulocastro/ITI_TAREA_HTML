						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Primer nombre</font></font></th>
											<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Apellido</font></font></th>
											<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nombre de usuario</font></font></th>
											<th class="col-xs-1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Acción</font></font></th>
										</tr>
									</thead>
									<tbody>
										<tr>
										...
										<tr>
											<td><input type="text" class="form-control" value="Castro"></td>
											<td><input type="text" class="form-control" value="Guerrero"></td>
											<td><input type="text" class="form-control" value="Uriegas"></td>
											<td class="text-center">
												<div class="list-icons">
							                		<a href="#" class="list-icons-item"><i class="icon-plus3 font-size-base"></i></a>
							                		<a href="#" class="list-icons-item"><i class="icon-cross2 font-size-base"></i></a>
					...
					<table class="table datatable-pagination">
						...
						<tbody>
							...
							<tr>
								<td>1930777</td>
								<td>Transpais</td>
								<td>Control de GPS</td>
								<td>Navegacion por GPS</td>
								<td><span class="badge badge-secondary">Inactive</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>Telmex</td>
								<td>Redes</td>
								<td>Manejo de diferentes redes</td>
								<td><span class="badge badge-info">Pending</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>Steren</td>
								<td>Conexiones</td>
								<td>Procedimiento para conectar</td>
								<td><span class="badge badge-secondary">Inactive</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
