				...
				<div class="card card-sidebar-mobile">
					...
					-->
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							-->
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link active">Registrar</a></li>
							<!--
					...
					-->
						...
						<!-- Components -->
						<!--
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Departamento</div> <i class="icon-menu" title="Components"></i></li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-grid"></i> <span>Departamentos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Basic components">
								<li class="nav-item"><a href="components_modals.html" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="components_dropdowns.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="components_tabs.html" class="nav-link">Enlistar</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Editar</span> -  Datos de Empleados</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Datos del empleado</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Entidad federativa</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Entidad federativa">
											<span class="input-group-append">
										</div>
									</div>
								</div>
							...
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Modulos</legend>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Numero de empleado</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-user"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="Numero de empleado">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Habilidades</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Habilidades">
											<span class="input-group-append">
										</div>
									</div>
								</div>
							...
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Empresa</legend>
							...
							<fieldset>
								<legend class="text-uppercase font-size-sm font-weight-bold">Habilidad</legend>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Habilidad">
											<span class="input-group-append">
										</div>
									</div>
								</div>
