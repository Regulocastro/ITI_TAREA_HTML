					...
					-->
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="form_inputs.html" class="nav-link active">Enlistar</a></li>
							<!--
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Agregar</span> - Datos de Empleados</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Datos de empleados</legend>
				...
				<!-- /input group addons -->
                        ...
                        <!--
							...
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Text0 color</label>
									<div class="col-lg-10">
