			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Handsontable</span> - Basic</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="handsontable_basic.html" class="breadcrumb-item">Handsontable</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Pedir Vacaciones</h5>
					...
					-->
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Datos de solicitud de vacaciones</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Salida</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Regreso</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											<input type="text" class="form-control" placeholder="Regreso">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Dias</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Motivo</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Salidad</font></font></th>
											<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Regreso</font></font></th>
											<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">dias</font></font></th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="Eduardo"></td>
											<td><input type="text" class="form-control" value="15/09/19"></td>
											<td><input type="text" class="form-control" value="17/09/19"></td>
											<td><input type="text" class="form-control" value="2"></td>
										</tr>
										<tr>
											<td><input type="text" class="form-control" value="Rocio"></td>
											<td><input type="text" class="form-control" value="13/10/19"></td>
											<td><input type="text" class="form-control" value="15/10/19"></td>
											<td><input type="text" class="form-control" value="2"></td>
										</tr>
										<tr>
											<td><input type="text" class="form-control" value="Jesus"></td>
											<td><input type="text" class="form-control" value="15/08/19"></td>
											<td><input type="text" class="form-control" value="23/08/19"></td>
